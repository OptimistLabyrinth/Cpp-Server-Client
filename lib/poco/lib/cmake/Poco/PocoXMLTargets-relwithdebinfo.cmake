...
set_target_properties(Poco::XML PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoXML.so.64"
  IMPORTED_SONAME_RELWITHDEBINFO "libPocoXML.so.64"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::XML )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::XML "${_IMPORT_PREFIX}/lib/libPocoXML.so.64" )
